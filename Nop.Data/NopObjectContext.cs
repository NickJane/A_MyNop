...
namespace Nop.Data
{
    ...
    public class NopObjectContext : DbContext, IDbContext
    {
        ...
        public IList<ResultEntity> ExecuteStoredProcedureDataTable<ResultEntity>(Func<DbDataReader, ResultEntity> objConvert, string commandText, params object[] parameters) where ResultEntity : class
        {
            //HACK: Entity Framework Code First doesn't support doesn't support output parameters
            //That's why we have to manually create command and execute it.
            //just wait until EF Code First starts support them
            ...
            {
                //no output parameters
                var result = this.Database.SqlQuery<ResultEntity>(commandText, parameters).ToList();
        ...
        public IList<ResultEntity> ExecuteStoredProcedure<ResultEntity>(Func<DbDataReader, ResultEntity> objConvert, string commandText, params object[] parameters) where ResultEntity : class
        {
            var connection = this.Database.Connection;
            //Don't close the connection after command execution
